...
const CREATE_TABLES: string[] = [
  ...
  `CREATE TABLE IF NOT EXISTS "KycSubmission" ("id" TEXT NOT NULL PRIMARY KEY,"userId" TEXT NOT NULL,"phone" TEXT,"fullName" TEXT,"cnic" TEXT,"email" TEXT,"dob" TEXT,"address" TEXT,"cnicFront" TEXT,"cnicBack" TEXT,"selfie" TEXT,"status" TEXT NOT NULL DEFAULT 'SUBMITTED',"adminNote" TEXT,"reviewedBy" TEXT,"reviewedAt" DATETIME,"createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP)`,
  ...
  `CREATE TABLE IF NOT EXISTS "Reel" ("id" TEXT NOT NULL PRIMARY KEY,"title" TEXT NOT NULL,"subtitle" TEXT,"videoPath" TEXT NOT NULL,"order" INTEGER NOT NULL DEFAULT 0,"createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP)`,
]
