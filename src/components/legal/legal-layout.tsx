    ...
    <main className="min-h-screen bg-background">
      <header className="sticky top-0 z-10 bg-background/80 backdrop-blur-xl border-b border-border">
        <div className="max-w-3xl mx-auto px-4 py-3 flex items-center justify-between">
          <Link href="/" aria-label="Smart Qarz home"><BrandLogo height={30} /></Link>
      ...
      <section className="geo-surface border-b border-border">
        <div className="max-w-3xl mx-auto px-4 pt-12 pb-8 text-center">
          <h1 className="font-display text-3xl sm:text-4xl font-bold text-foreground tracking-tight">{title}</h1>
      ...
      <article className="max-w-3xl mx-auto px-4 py-10">
        <div className="geo-card p-6 sm:p-8 text-sm leading-relaxed text-muted-foreground">{children}</div>
      </article>

      <footer className="border-t border-border bg-secondary/40">
        <div className="max-w-3xl mx-auto px-4 py-6 text-center text-xs text-muted-foreground">
          © {new Date().getFullYear()} Smart Qarz (Pvt) Ltd ·{' '}
