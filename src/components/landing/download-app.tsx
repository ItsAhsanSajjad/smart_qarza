  ...
  return (
    <>
      <button
        ...
        aria-label="Download the GEO Loan.pk Android app"
        className="geo-shine group inline-flex items-center gap-3 bg-slate-900 text-white pl-2.5 pr-5 py-2.5 rounded-2xl shadow-lg shadow-slate-900/20 ring-1 ring-white/10 hover:-translate-y-0.5 hover:shadow-xl transition-all duration-300"
      >
        ...
        <span className="text-left leading-tight">
          <span className="flex items-center gap-1 text-[10px] uppercase tracking-wider text-white/60 font-semibold">
            <ShieldCheck className="w-3 h-3 text-emerald-400" /> Verified Android app
          </span>
          <span className="block text-[15px] font-bold mt-0.5">Download GEO Loan.pk</span>
        </span>
      </button>
          ...
          >
            ...
            >
              ...
              <div className="relative p-5 pb-4">
                <button onClick={() => setOpen(false)} className="absolute top-3 right-3 p-1.5 rounded-lg text-slate-400 hover:bg-muted hover:text-slate-700 transition">
                  <X className="w-4 h-4" />
                </button>
                <div className="flex items-center gap-3.5">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src="/icon-192.png" alt="GEO Loan.pk" className="w-16 h-16 rounded-2xl border border-border shadow-sm shrink-0" />
                  <div className="min-w-0">
                    <div className="font-bold text-slate-900 text-lg leading-tight">GEO Loan.pk</div>
                    <div className="text-xs text-primary font-medium">GEO Loan (Pvt) Ltd</div>
                ...
                <div className="grid grid-cols-3 divide-x divide-border mt-4">
                  <div className="text-center">
                    <div className="flex items-center justify-center gap-0.5 font-bold text-slate-900 text-sm">4.8 <Star className="w-3 h-3 fill-amber-400 text-amber-400" /></div>
                    <div className="text-[10px] text-muted-foreground">Rating</div>
                  </div>
                  <div className="text-center">
                    <div className="font-bold text-slate-900 text-sm">{size || '—'}</div>
                    <div className="text-[10px] text-muted-foreground">Size</div>
                  </div>
                  <div className="text-center">
                    <div className="flex items-center justify-center gap-1 font-bold text-slate-900 text-sm"><Smartphone className="w-3.5 h-3.5" /></div>
              ...
              {/* security badge */}
              <div className="mx-5 mb-4 flex items-center gap-2 rounded-xl bg-emerald-50 border border-emerald-200 px-3 py-2 text-xs text-emerald-700">
              ...
              <div className="p-5 pt-0">
                ...
                {phase === 'done' && (
                  <div className="text-center py-1">
                    <div className="inline-flex items-center gap-1.5 text-emerald-600 font-semibold text-sm">
                ...
                <p className="text-[10px] text-center text-muted-foreground mt-3">Official app · Secure direct download from geoloan.pk</p>
              </div>
            </motion.div>
          </motion.div>
        )}
